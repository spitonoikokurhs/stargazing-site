...
export const metadata: Metadata = {
  title: 'Tonight’s Sky (v2) — the verdict | Stargazing Events',
  description:
    'A verdict-first read of tonight’s sky: is it a dark night worth planning, what’s worth looking at, and when the sky is actually moon-free.',
  robots: { index: false, follow: false }, // v2 is a comparison build — not indexed
}
